...
ansible-playbook -i "$PUBLIC_IP," playbook.yml --private-key=~/terraform_minecraft_server/.aws/keys/minecraft_project_2 -u ubuntu --extra-vars "ansible_python_interpreter=/usr/bin/python3"
